...
pause(1)
individualArmRound2(pouch4, env_new) 
pause(1)
individualArmRound2(pouch5, env_new)  
pause(1)
individualArmRound2(pouch6, env_new)
pause(1)
individualArmRound2(pouch7, env_new)
pause(1)
individualArmRound2(pouch8, env_new) 
pause(1)
